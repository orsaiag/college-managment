...
public class View {
	...
	public static void loginView() throws IOException, CloneNotSupportedException {
		String id, pass;
		Scanner sc;
	...
	public static void viewStudent(Student std) throws IOException {
		...
		while (selectedOption.equals("6") == false) {
			...
			System.out.println("press 4 to show my courses");
			...
			case "2": {
				while (editOption.equals("5") == false && editOption.equals("4") == false) {
					...
					System.out.println("4 - Back only");
					System.out.println("5 - Save and Back");
					...
					case "5": {
						...
						boolean request = std2.sendRequestChangeDetails(std2.getId(), std2.getName(), std2.getAddress(),
								std.getEmail());
						if (request == true) {
							Request re = new Request();
							re.createRequest(numLines, std2.getId(), std2.getName(), std2.getEmail(), std2.getPassword(),std2.getAddress(),
									 std2.getDateOfBirth(), std2.getNumberOfCourse());
						} else
			...
			case "3": {
				System.out.print(Controller.controllerViewGrades(std2.getId(), "Grades.txt"));
				System.out.println();
				break;
			}
			case "4": {
				print = std2.getMyCourses();
				System.out.println(Arrays.toString(print));
				break;
			}
			case "5": {
				int numberOfCourse = std.getNumberOfCourse();
		...
		while (selectedOption.equals("6") == false) {
			...
			case "2": {
				while (editOption.equals("5") == false && editOption.equals("4") == false) {
					...
					case "5": {
						numLines = (Controller.controllerShowLine("ReqeustInformation.txt")) + 1;
						boolean request = tut2.sendRequestChangeDetails(tut2.getId(), tut2.getName(), tut2.getAddress(),
								tut.getEmail());
						if (request == true) {
							Request re = new Request();
							re.createRequest(numLines, tut2.getId(), tut2.getName(), tut2.getEmail(), 
									tut2.getPassword(),tut2.getAddress(), tut2.getDateOfBirth(), tut2.getSalary());
						} else
							System.out.println("nothing changed");
						break;
					}
			...
			case "4": {
				...
				System.out
						.println(Controller.controllershowStudentPerLecturerOrTutor(tut.getId(), "TutorAndCourse.txt"));
				break;
			}
			case "5": {
				System.out.println("The grades and average information: ");
				System.out.println(Controller.controllerShowGradesOfAllStudents("Grades.txt"));
				break;
			}
			case "6": {
				System.out.println("Goodbye");
		...
		while (selectedOption.equals("7") == false) {
			...
			case "2": {
				while (editOption.equals("5") == false && editOption.equals("4") == false) {
					...
					case "5": {
						numLines = (Controller.controllerShowLine("ReqeustInformation.txt")) + 1;
						boolean request = lec2.sendRequestChangeDetails(lec2.getId(), lec2.getName(), lec2.getAddress(),
								lec2.getEmail());
						if (request == true) {
							Request re = new Request();
							re.createRequest(numLines, lec2.getId(), lec2.getName(), lec2.getEmail(), 
									lec2.getPassword(),lec2.getAddress(), lec2.getDateOfBirth(), lec2.getSalary());
						} else
							System.out.println("nothing changed");
						break;
					}
			...
			case "5": {
				...
				case "1": {
					...
					System.out.println(Controller.controllerChaneGrades(id, oldGrade, newGrade));
					break;
				}
				case "2": {
					...
					grade = scan.nextLine();
					// System.out.println(Controller.controllerAddGrade(id, course, type, grade));
					if (Controller.controllerAddGrade(id, course, type, grade) == true)
						System.out.println("The grade was added succefully");
					else
						System.out.println("The grade was NOT added succefully");
					break;
				}
				}
				break;
		...
		while (selectedOption.equals("3") == false) {
			...
			case "2": {
				while (editOption.equals("5") == false && editOption.equals("4") == false) {
					...
					case "5": {
						numLines = (Controller.controllerShowLine("ReqeustInformation.txt")) + 1;
						boolean request = jan2.sendRequestChangeDetails(jan2.getId(), jan2.getName(), jan2.getAddress(),
								jan2.getEmail());
						if (request == true) {
							Request re = new Request();
							re.createRequest(numLines, jan2.getId(), jan2.getName(), jan2.getEmail(), 
									jan2.getPassword(),jan2.getAddress(), jan2.getDateOfBirth(), jan2.getSalary());
						} else
							System.out.println("nothing changed");
						break;
					}
		...
		while (selectedOption.equals("7") == false) {
			...
			case "2": {
				...
				case "1": {
					System.out.println("Enter your new name:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Secretary.txt", sec.getId(), sec.getName(),
							editOption));
				...
				case "2": {
					System.out.println("Enter your new email:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Secretary.txt", sec.getId(), sec.getEmail(),
							editOption));
				...
				case "3": {
					System.out.println("Enter your new address:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Secretary.txt", sec.getId(),
							sec.getAddress(), editOption));
			...
			case "3": {
				while (editOption.equals("5") == false) {
					...
					switch (editOption) {
					case "1": {
						System.out.println("The number of requests are: "
								+ Controller.controllerSecrateryShowNumberOfRequests("ReqeustInformation.txt"));
						break;
					}
					case "2": {
						System.out.println("The Waiting requests are:");
						System.out
								.println(Controller.controllerSecrateryShowRequestsToApprove("ReqeustInformation.txt"));
						break;
					}
					case "3": {
			...
			case "6": {
				String id = null, name = null, email = null, password = null, address = null, dateOfBirth = null,
				...
				System.out.println(
						"please enter type of person: 1-student, 2-tutor, 3-lecturer , 4-janitor, 5-secratery ,6-principle");
				type = scan.nextLine();
				...
				if (Controller.controllerAddNewStuentOrWorker(typen, id, name, email, password, address, dateOfBirth,
						num))
	...
	@SuppressWarnings("resource")
	public static void viewPrinciple(Principal prin) throws IOException {
		String editOption = "";
		String selectedOption = "";
		Scanner sc = null;
		System.out.println("Welcome " + prin.getName());
		sc = new Scanner(System.in);
		...
		while (selectedOption.equals("5") == false) {
			...
			case "2": {
				...
				case "1": {
					System.out.println("Enter your new name:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Principle.txt", prin.getId(), prin.getName(),
							editOption));
					prin.setName(editOption);
					break;
				}
				case "2": {
					System.out.println("Enter your new email:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Principle.txt", prin.getId(), prin.getEmail(),
							editOption));
					prin.setEmail(editOption);
					break;
				}
				case "3": {
					System.out.println("Enter your new address:");
					editOption = sc.nextLine();
					System.out.println(Controller.controllerSecratery("Principle.txt", prin.getId(),
							prin.getAddress(), editOption));
					prin.setAddress(editOption);
					break;
				}
				case "4": {
					break;
				...
				while (editOption.equals("4") == false) {
					...
					case "1": {
						System.out.println("The number of students are: "
								+ Controller.controllerSecrateryShowNumberOfRequests("Student.txt"));
						break;
					}
					case "2": {
